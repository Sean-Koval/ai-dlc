...
**Spec:** [spec-delivery-traceability](specs/spec-delivery-traceability/spec.md)
...
- Read AGENTS.md, ai-dlc.toml, the current work record, docs/product-direction.md, the [shared implementation clarifications](../../../../docs/design/framework-delivery.md#frozen-cross-ticket-contracts), and this ticket's specification (or predecessor contracts for verification work) before edits.
...
Local checks and scoped consumer evidence: [verification report](../../../../docs/verification/spec-delivery-traceability.md).
