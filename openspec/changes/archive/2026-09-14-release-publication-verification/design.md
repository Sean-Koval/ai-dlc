...
Pass the selected tag through RELEASE_TAG and quote it in gh arguments. Consumers initialize the seed locally, generate a demo, compare the retained manifest, and run the demo release-mode bootstrap locally before explicit github-actions checks. GITHUB_PATH publication is independent of the selected setup target. No change to the production stale-generated rejection.
