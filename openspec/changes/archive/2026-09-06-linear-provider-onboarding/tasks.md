...
- [x] 2.2 Implement plan_linear_connection and apply_linear_connection: validate selection membership/types and config digest, preserve comments and unrelated sections, write atomically, and prove invalid/stale selections write nothing. Task 3 owns CLI wiring and fresh remote membership checks.
...
[Detailed plan](2026-09-05-linear-provider-onboarding.md).
