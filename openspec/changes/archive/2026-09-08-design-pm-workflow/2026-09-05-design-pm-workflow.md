...
**Spec:** [design-pm-workflow](specs/design-pm/spec.md)
...
application/source review remain pending. See [verification evidence](../../../../docs/verification/design-pm-workflow.md).
