...
Current steering (September 7): follow the [current roadmap](../../../../docs/roadmap.md) and GitHub issues.
...
**Spec:** [provider-toolset-onboarding](specs/provider-toolset-onboarding/spec.md).

Status: draft. Global constraints from [master plan](../../../../docs/archive/planning/2026-09-06-provider-toolsets.md) apply.
