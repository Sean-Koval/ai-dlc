...
- [ ] 1.1 Introduce optional capability discovery and preserve legacy adapters; demonstrate failing regressions before implementation and run the mapped focused checks.
- [ ] 1.1a Integrate existing GitHub Issues with generic repository/account onboarding, shared lifecycle and recovery tests, and disposable live qualification; preserve identity and SCM behavior without requiring Projects.
...
[Execution plan](../../../docs/superpowers/plans/2026-09-06-portable-tracker-adapters.md). All items are proposed work, not delivered behavior.
