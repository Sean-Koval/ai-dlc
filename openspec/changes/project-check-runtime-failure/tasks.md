...
## Implementation
- [ ] 1.1 Raise a dedicated unavailable-runtime error carrying the executable and remedy, with regression tests.
- [ ] 1.2 Render a structured nonzero failure from `project check` for human and JSON output without a receipt, with regression tests.
