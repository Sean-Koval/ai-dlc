# obsidian-native-project-mounts Specification

## Purpose
Expose canonical project documentation and specifications as explicit local Obsidian mounts while preserving private-note and filesystem boundaries.
