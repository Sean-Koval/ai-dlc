# obsidian-vault-linking Specification

## Purpose
Provide additive canonical documentation navigation, explicit ownership diagnostics and machine-local Obsidian portals while preserving authored files, private knowledge boundaries and independent specification and publication authority.
## Requirements
