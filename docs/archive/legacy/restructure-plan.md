> Historical record relocated during repository organization. It is not current
> implementation guidance. Consult the project documentation index, canonical
> OpenSpec requirements and tracker for current behavior and work status.
