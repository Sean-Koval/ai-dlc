# Roadmap ledger, September 2026

These sections were moved verbatim from `docs/roadmap.md` on 2026-09-14 so the
roadmap can state the current outcome and next increments only. They record
delivery and cancellation as reconciled on September 10, 2026; they are not a
queue to execute, and cancelled issues do not prove delivery of their scope.
Relative links were rewritten for this location; wording is unchanged.
