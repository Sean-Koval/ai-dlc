...
| 2 | GitHub Issues plus optional Projects onboarding and shared lifecycle qualification | [Tracker adapters, Tasks 1 and 1a](../../../openspec/changes/portable-tracker-adapters/2026-09-06-portable-tracker-adapters.md) | Setup interfaces; no Plane deployment prerequisite |
| 3 | Plane native connection plus thin lifecycle adapter | [Tracker adapters, Task 2](../../../openspec/changes/portable-tracker-adapters/2026-09-06-portable-tracker-adapters.md) | Setup interfaces; local deployment for live qualification |
| 4 | Rehearse default-only and selected migration; switch personal work to GitHub only after reviewing mappings | [Migration](../../../openspec/changes/selective-tracker-migration/2026-09-06-selective-tracker-migration.md) | Qualified selected target; GitHub path does not wait for Plane |
| 5 | Jira adapter and work-project toolset; same lifecycle without another workflow branch | [Tracker adapters, Task 3](../../../openspec/changes/portable-tracker-adapters/2026-09-06-portable-tracker-adapters.md) | Work deployment/authentication decision; can run alongside migration |
