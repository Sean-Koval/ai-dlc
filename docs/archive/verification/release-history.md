...
These dated sections were moved verbatim from `docs/release-verification.md` on
2026-09-14. Each applies only to its stated revision and environment; none
establishes live readiness, and nothing here was satisfied by the move. The
current page keeps what a release must prove, the outstanding list and the
latest dated evidence. Relative links were rewritten for this location.
