...
def validate_plan(plan):
    ...
    from ai_dlc.github_onboarding import _require
...
def preview(root, *, alias, host, repository, environ, plan_file=None):
    from ai_dlc.github_onboarding import (
        _guard_bound,
        _query,
        _render,
        _require,
    ...
    if selected:
        ...
        from ai_dlc.github_onboarding import _connect_existing_github
...
def _check_local(root, saved, environ):
    from ai_dlc.github_onboarding import _snapshot
